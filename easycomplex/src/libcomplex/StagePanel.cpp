...
{
	m_arrange_impl = new ArrangeSpriteImpl(this, property);
	m_edit_op = new d2d::ArrangeSpriteOP<SelectSpritesOP>(this, this, property, 
		view_panel_mgr, NULL, d2d::ArrangeSpriteConfig(), m_arrange_impl);
