...
tpack_png = os.path.join(root, ur"build\tex_lua_for_ep\buildings21.png")
...
os.system('%s build_tpack_py.lua "%s" tpack.py' % (lua_exe, tpack_lua))
...
os.system('%s "%s" -png "%s"' % (lua_exe, epgen_script, epgen_lua))
