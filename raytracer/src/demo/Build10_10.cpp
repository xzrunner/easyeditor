...
void World::Build(void) 
{
	...
	//thin_lens->SetFocalDistance(50.0);	// for Figure 10.10(a)
	//thin_lens->SetFocalDistance(74.0);	// for Figure 10.10(b) 
	thin_lens->SetFocalDistance(98.0);	// for Figure 10.10(c)	thin_lens->SetLensRadius(1.0);	  // for Figure 10.9(b)
