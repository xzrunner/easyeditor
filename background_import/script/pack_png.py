...
WORK_ITEMS = [
        (
            '..\\data\\json_scene1',
            '..\\data\\pack\\scene_bg1png',
            '..\\data\\pack\\scene_bg1png.lua',
            '..\\data\\pack\\scene_bg1png.ep'
        ),
        (
            '..\\data\\json_scene2',
            '..\\data\\pack\\scene_bg2png',
            '..\\data\\pack\\scene_bg2png.lua',
            '..\\data\\pack\\scene_bg2png.ep'
        ),
        (
            '..\\data\\json_scene3',
            '..\\data\\pack\\scene_bg3png',
            '..\\data\\pack\\scene_bg3png.lua',
            '..\\data\\pack\\scene_bg3png.ep'
        ),
    ]
