...
void PackP3dSpr::UnpackFromLua(lua_State* L, const std::vector<ee::ImagePtr>& images)
{
...
void PackP3dSpr::UnpackFromBin(uint8_t** ptr, const std::vector<ee::ImagePtr>& images)
{
