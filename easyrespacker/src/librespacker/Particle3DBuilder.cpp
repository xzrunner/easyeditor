...
void Particle3DBuilder::Load(const std::shared_ptr<const eparticle3d::Symbol>& sym, PackParticle3D* ps)
{
	...
	for (int i = 0; i < cfg->sym_count; ++i) 
	{
		...
		comp.mul_col_begin = gum::color2int(s2::Color(p_symbol.mul_col_begin.r, p_symbol.mul_col_begin.g, p_symbol.mul_col_begin.b, p_symbol.mul_col_begin.a), bsn::ARGB);
		comp.mul_col_end = gum::color2int(s2::Color(p_symbol.mul_col_end.r, p_symbol.mul_col_end.g, p_symbol.mul_col_end.b, p_symbol.mul_col_end.a), bsn::ARGB);
		comp.add_col_begin = gum::color2int(s2::Color(p_symbol.add_col_begin.r, p_symbol.add_col_begin.g, p_symbol.add_col_begin.b, p_symbol.add_col_begin.a), bsn::ARGB);
		comp.add_col_end = gum::color2int(s2::Color(p_symbol.add_col_end.r, p_symbol.add_col_end.g, p_symbol.add_col_end.b, p_symbol.add_col_end.a), bsn::ARGB);
