...
Component(const p3d_symbol& sym)
{
	...
	m_mul_col_begin		= gum::color2int(sym.mul_col_begin.rgba, gum::PT_ARGB);
	m_mul_col_end		= gum::color2int(sym.mul_col_end.rgba, gum::PT_ARGB);
	m_add_col_begin		= gum::color2int(sym.add_col_begin.rgba, gum::PT_ARGB);
	m_add_col_end		= gum::color2int(sym.add_col_end.rgba, gum::PT_ARGB);
