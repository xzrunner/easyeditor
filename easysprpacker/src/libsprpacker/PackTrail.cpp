...
CompImage(const t2d_symbol& sym)
{
	...
	m_mul_col_begin		= gum::color2int(sym.col_begin.rgba, s2s::RGBA);
	m_mul_col_end		= gum::color2int(sym.col_end.rgba, s2s::RGBA);
	m_add_col_begin		= gum::color2int(sym.mode.A.add_col_begin.rgba, s2s::RGBA);
	m_add_col_end		= gum::color2int(sym.mode.A.add_col_end.rgba, s2s::RGBA);
}
...
CompShape(const t2d_symbol& sym)
{
	...
	m_col_begin		= gum::color2int(sym.col_begin.rgba, s2s::RGBA);
	m_col_end		= gum::color2int(sym.col_end.rgba, s2s::RGBA);
}
