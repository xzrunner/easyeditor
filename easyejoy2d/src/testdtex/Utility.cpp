								   ...
								   bool load_tex, int lod/*, bool load_texture_async*/)
{
	...
	while (true)
	{
		std::string path;
		if (lod == 1) {
			path = pkg_name	+ "." + d2d::StringHelper::ToString(idx) + ".50.ept";
		} else if (lod == 2) {
			path = pkg_name	+ "." + d2d::StringHelper::ToString(idx) + ".25.ept";
		} else {
			path = pkg_name	+ "." + d2d::StringHelper::ToString(idx) + ".ept";
		}
...
// 			std::string filepath = pkg_name	+ "." + d2d::StringHelper::ToString(i+1) + ".ept";
