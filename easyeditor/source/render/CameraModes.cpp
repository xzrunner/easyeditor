...
{
	m_modes.push_back(Item(pt2::CM_ORTHO, "正交"));
	m_modes.push_back(Item(pt2::CM_PERSPECTIVE_NO_HEIGHT, "投影没高度"));
	m_modes.push_back(Item(pt2::CM_PERSPECTIVE_AUTO_HEIGHT, "投影计算高度"));
}
