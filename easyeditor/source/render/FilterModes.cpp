...
{
	m_modes.push_back(Item(s2::FM_NULL, "null", "ÎÞ"));

	m_modes.push_back(Item(s2::FM_EDGE_DETECTION, "edge detection", "±ß½ç¼ì²â"));
	m_modes.push_back(Item(s2::FM_RELIEF, "relief", "¸¡µñ"));
	m_modes.push_back(Item(s2::FM_OUTLINE, "outline", "°üÎ§"));

	m_modes.push_back(Item(s2::FM_GRAY, "gray", "»Ò¶È"));
	m_modes.push_back(Item(s2::FM_BLUR, "blur", "Ä£ºý"));
	m_modes.push_back(Item(s2::FM_GAUSSIAN_BLUR, "gaussian blur", "¸ßË¹Ä£ºý"));
