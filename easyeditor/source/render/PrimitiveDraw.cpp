...
//}
//
//void RVG::Rect(const Vector& center, float hWidth, float hHeight, const ShapeStyle& style)
//{
//	DrawRect(center - Vector(hWidth, hHeight), center + Vector(hWidth, hHeight), style);
//}
//
//void RVG::Rect(const Rect& r, const ShapeStyle& style)
//{
...
//}
//
//void RVG::Circle(const Vector& center, float radius, bool isFill/* = false*/, 
...
//}
//
//void RVG::Circle(const Matrix& mt, const Vector& center, float radius, bool isFill/* = false*/, 
//							   float size/* = 2*/, const Colorf& color/* = Colorf(0, 0, 0)*/, size_t kSegments/* = 16*/)
//{
//	PrimitiveDrawNew::SetColor(color);
//	const float k_increment = 2.0f * PI / kSegments;
