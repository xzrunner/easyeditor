...
//}
//
//void StripMesh::Load(const Json::Value& value)
//{
...
//}
//
//void StripMesh::Store(Json::Value& value) const
//{
...
//}
//
//void StripMesh::OffsetUV(float dx, float dy)
//{
//	// update uv base
//	m_uv_offset += dy;
...
//}
//
//void StripMesh::Reset()
//{
//	m_uv_offset = 0;
//	RefreshTriangles();
//}
//
//void StripMesh::Clear()
//{
//	InitBound();
//	RefreshTriangles();
//}
//
//void StripMesh::InsertNode(const sm::vec2& p)
//{
...
//}
//
//void StripMesh::RemoveNode(const sm::vec2& p)
//{
//	assert(m_left_nodes.Size() >= 2 && m_right_nodes.Size() >= 2);
//
//	int idx;
...
//}
//
//sm::vec2* StripMesh::FindNode(const sm::vec2& p)
//{
//	assert(m_left_nodes.Size() >= 2 && m_right_nodes.Size() >= 2);
//
...
//}
//
//void StripMesh::MoveNode(sm::vec2* src, const sm::vec2& dst)
//{
//	assert(m_left_nodes.Size() >= 2 && m_right_nodes.Size() >= 2);
//
//	if (!src) return;
...
//}
//
//void StripMesh::AbsorbNodeToRegion(sm::vec2& node)
//{
...
//}
//
//void StripMesh::GetTransList(std::vector<std::pair<sm::vec2, sm::vec2> >& trans_list) const
//{
...
//}
//
//void StripMesh::TranslateNode(s2::MeshNode* node, const std::vector<std::pair<sm::vec2, sm::vec2> >& trans_list)
//{
...
//}
//
//void StripMesh::TranslateNode(sm::vec2& node, const std::vector<std::pair<sm::vec2, sm::vec2> >& trans_list)
//{
//	for (int i = 0, m = trans_list.size(); i < m; ++i)
//	{
...
//}
//
//void StripMesh::MapUV2XY(const std::vector<sm::vec2>& nodes, int index, const sm::vec2& pos, 
//					 std::vector<std::pair<sm::vec2, sm::vec2> >& trans_list)
//{
