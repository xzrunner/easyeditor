...
/* ./.libs/lt-gif2raw.c - temporary wrapper executable for .libs/gif2raw.exe
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.3ubuntu1

   The gif2raw program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "gif2raw.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# gif2raw - temporary wrapper script for .libs/gif2raw.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.3ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The gif2raw program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"gif2raw.exe:gif2raw:${LINENO}: libtool wrapper (GNU libtool) 2.4.2 De", f);
  fputs ("bian-2.4.2-1.3ubuntu1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"gif2raw.exe:gif2raw:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"gif2raw.exe:gif2raw:${LINENO}: newargv[0]: $progdir/$program\" 1>", f);
  fputs ("&2\n", f);
