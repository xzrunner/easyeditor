...
/* ./.libs/lt-gifbg.c - temporary wrapper executable for .libs/gifbg.exe
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.3ubuntu1

   The gifbg program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "gifbg.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# gifbg - temporary wrapper script for .libs/gifbg.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.3ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The gifbg program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"gifbg.exe:gifbg:${LINENO}: libtool wrapper (GNU libtool) 2.4.2 Debian", f);
  fputs ("-2.4.2-1.3ubuntu1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"gifbg.exe:gifbg:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"gifbg.exe:gifbg:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
