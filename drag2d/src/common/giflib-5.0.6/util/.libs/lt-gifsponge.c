...
/* ./.libs/lt-gifsponge.c - temporary wrapper executable for .libs/gifsponge.exe
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.3ubuntu1

   The gifsponge program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "d:\\projects\\giflib-5.0.6\\lib\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "d:\\projects\\giflib-5.0.6\\lib\\.libs;C:\\MinGW\\msys\\1.0\\local\\lib;C:\\MinGW\\msys\\1.0\\local\\bin;";
const char * TARGET_PROGRAM_NAME = "gifsponge.exe"; /* hopefully, no .exe */
...
main (int argc, char *argv[])
{
  ...
  lt_debugprintf (__FILE__, __LINE__, "libtool wrapper (GNU libtool) 2.4.2 Debian-2.4.2-1.3ubuntu1\n");
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# gifsponge - temporary wrapper script for .libs/gifsponge.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.3ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The gifsponge program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ../lib/libgif.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"gifsponge.exe:gifsponge:${LINENO}: libtool wrapper (GNU libtool) 2.4.", f);
  fputs ("2 Debian-2.4.2-1.3ubuntu1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"gifsponge.exe:gifsponge:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg", f);
  fputs ("\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"gifsponge.exe:gifsponge:${LINENO}: newargv[0]: $progdir/$program", f);
  fputs ("\" 1>&2\n", f);
  ...
  fputs ("    PATH=/d/projects/giflib-5.0.6/lib/.libs:/usr/local/lib:/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/d/projects/giflib-5.0.6/lib/.libs:$PATH\"\n", f);
  fputs ("\n", f);
