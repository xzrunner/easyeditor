...
/* ./.libs/lt-gifinto.c - temporary wrapper executable for .libs/gifinto.exe
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.3ubuntu1

   The gifinto program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "gifinto.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# gifinto - temporary wrapper script for .libs/gifinto.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.3ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The gifinto program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"gifinto.exe:gifinto:${LINENO}: libtool wrapper (GNU libtool) 2.4.2 De", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"gifinto.exe:gifinto:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"gifinto.exe:gifinto:${LINENO}: newargv[0]: $progdir/$program\" 1>", f);
  fputs ("&2\n", f);
