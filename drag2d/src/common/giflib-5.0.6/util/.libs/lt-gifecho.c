...
/* ./.libs/lt-gifecho.c - temporary wrapper executable for .libs/gifecho.exe
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.3ubuntu1

   The gifecho program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "gifecho.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# gifecho - temporary wrapper script for .libs/gifecho.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.3ubuntu1\n", f);
  fputs ("#\n", f);
  fputs ("# The gifecho program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"gifecho.exe:gifecho:${LINENO}: libtool wrapper (GNU libtool) 2.4.2 De", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"gifecho.exe:gifecho:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"gifecho.exe:gifecho:${LINENO}: newargv[0]: $progdir/$program\" 1>", f);
  fputs ("&2\n", f);
