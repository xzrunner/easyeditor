 ...
 */
void viter_init(const colormap *map, const int max_threads, const std::vector<viter_state>& average_color)
{
    memset((void*) &average_color[0], 0, sizeof(average_color[0])*map->colors*max_threads);
}

void viter_update_color(const f_pixel acolor, const float value, const colormap *map, int match, const int thread, std::vector<viter_state>& average_color)
{
...
void viter_finalize(colormap *map, const int max_threads, const std::vector<viter_state>& average_color)
{
