...
typedef struct {
 ...
 struct f_pixel
 {
  	float a, r, g, b;
   	...
   	f_pixel(float _a, float _r, float _g, float _b)
   		: a(_a), r(_r), g(_g), b(_b) {}
 };
...
inline static rgb_pixel to_rgb(float gamma, f_pixel px)
{
	...
	rgb_pixel ret;
	ret.r = r>=255.f ? 255 : (r<=0.f ? 0 : r);
	ret.g = g>=255.f ? 255 : (g<=0.f ? 0 : g);
	ret.b = b>=255.f ? 255 : (b<=0.f ? 0 : b);
	ret.a = a>=255.f ? 255 : a;
	return ret;
}
