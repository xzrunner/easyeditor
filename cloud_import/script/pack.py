...
WORK_ITEMS = [
        (
            r'..\data\json',
            r'..\data\pack\clouds',
            r'..\data\pack\clouds.tmp.lua',
            '1.0',
            r'..\data\pack\clouds.lua',
            r'..\data\pack\clouds.ep',
        ),
        (
            r'..\data\json',
            r'..\data\pack\clouds_lowres',
            r'..\data\pack\clouds_lowres.tmp.lua',
            '0.5',
            r'..\data\pack\clouds_lowres.lua',
            r'..\data\pack\clouds_lowres.ep',
        ),
    ]
...
for ed_json, tp_json, tmp_lua, scale, lua, ep in WORK_ITEMS:
    ...
    if '3' in options:
        run_cmd('%s %s %s %s' % (LUA, EPBIN, IMAGE_FLAG, lua))
