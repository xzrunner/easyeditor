#ifndef _EASY2D_COLOR_H_
#define _EASY2D_COLOR_H_
...
inline Colorf col_mul(const Colorf& a, const Colorf& b)
{
	Colorf ret;
	ret.r = a.r * b.r;
	ret.g = a.g * b.g;
...
inline Colorf col_add(const Colorf& a, const Colorf& b)
{
	Colorf ret;
...
inline Colorf col_interpolate(const Colorf& begin, const Colorf& end, float scale)
{
	Colorf ret;
