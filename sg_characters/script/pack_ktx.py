...
WORK_ITEMS = [
        (
            r'..\data\json',
            r'..\data\pack\characters2ktx',
            r'..\data\pack\characters2ktx.tmp.lua',
            '1.0',
            r'..\data\pack\characters2ktx.lua',
            r'..\data\pack\characters2ktx.ep',
        ),
    ]
...
for ed_json, tp_json, tmp_lua, scale, lua, ep in WORK_ITEMS:
    ...
    if '3' in options:
        run_cmd('%s %s -ktx %s' % (LUA, EPBIN, lua))
