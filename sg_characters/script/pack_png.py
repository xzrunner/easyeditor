...
WORK_ITEMS = [
        (
            r'..\data\json',
            r'..\data\pack\characters2png',
            r'..\data\pack\characters2png.tmp.lua',
            '1.0',
            r'..\data\pack\characters2png.lua',
            r'..\data\pack\characters2png.ep',
        ),
        # (
        #     r'..\data\json',
        #     r'..\data\pack\characters2_lowrespng',
        #     r'..\data\pack\characters2_lowrespng.tmp.lua',
        #     '0.5',
        #     r'..\data\pack\characters2_lowrespng.lua',
        #     r'..\data\pack\characters2_lowrespng.ep',
        # ),
    ]
...
for ed_json, tp_json, tmp_lua, scale, lua, ep in WORK_ITEMS:
    ...
    if '3' in options:
        run_cmd('%s %s -ep -png4 %s' % (LUA, EPBIN, lua))
