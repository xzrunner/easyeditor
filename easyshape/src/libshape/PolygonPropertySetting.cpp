...
PolygonPropertySetting::PolygonPropertySetting(d2d::EditPanel* editPanel, 
											   PolygonShape* poly)
...
void PolygonPropertySetting::updatePanel(d2d::PropertySettingPanel* panel)
{
...
void PolygonPropertySetting::updatePropertyGrid(d2d::PropertySettingPanel* panel)
{
	updatePanel(panel);
}

void PolygonPropertySetting::enablePropertyGrid(d2d::PropertySettingPanel* panel, bool bEnable)
{
	wxPropertyGrid* pg = panel->getPG();
