...
//	while (p != pLast)
//	{
//		glBindTexture(GL_TEXTURE_2D, p->pc->image->textureID());
//
//		glPushMatrix();
//
//		memset(vertices, 255, sizeof(vertex)*4);
//
//		const float hw = p->pc->image->width() * 0.5f,
//			hh = p->pc->image->height() * 0.5f;
//
...
//		float s = (p->life / p->lifetime) * (p->pc->start_scale - p->pc->end_scale) + p->pc->end_scale;
//
//		static love::Matrix t;
//		t.setTransformation(x, y, p->angle, s, s, 0, 0, 0, 0);
////		t.setTransformation(x, y, p->rotate, s, s, 0, 0, 0, 0);
