...
wxSizer* ToolbarPanel::CreateModeGravityLayout()
{
	...
	top_sizer->AddSpacer(10);
	m_sliders.push_back(s_tangential);
	// radial accel
...
wxSizer* ToolbarPanel::CreateModeRadiusLayout()
{
	...
	top_sizer->AddSpacer(10);
	m_sliders.push_back(s_end_radius);
	// Direction Delta
	...
	top_sizer->AddSpacer(10);
	m_sliders.push_back(s_direction_spd);
...
wxSizer* ToolbarPanel::CreateModeSpdCosLayout()
{
	...
	top_sizer->AddSpacer(10);
	m_sliders.push_back(s_cos_amplitude);
	// Cos Frequency
	...
	top_sizer->AddSpacer(10);
	m_sliders.push_back(s_cos_frequency);
